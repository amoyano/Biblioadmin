 ...
 * ConfigWindow.java
 *
 * Created on 10 Ноябрь 2006 г., 9:06
 *
 */
...
/**
 * Component's configuration window. <br>
 * Окно настройки компонентов.
...
public class ConfigWindow extends JFrame implements  CommitListener, SelectionChangedListener{
    ...
    /**
     * Используется как имя ключа при идентификации меню.
     */
    private static final String MENU_PROPERTY_ID = "MenuItemID";
    /**
     * Используется для идентификации меню "Загрузка"
     */
    private static final String MENU_LOAD = "load";
    /**
     * Используется для идентификации меню "Сохранить"
     */
    private static final String MENU_SAVE = "save";
    /**
     * Используется для идентификации меню "Сохранить как..."
     */
    ...
    private JMenu createMenuHelp() {
        ...
        aboutString.append(", 2006<br>");
        aboutString.append("e-mail: <i>androsovvi@mail.ru</i>");
    ...
    /**
     * Handles "commit" component event (updates list of selected dates). <br>
     * Обрабатывает событие "commit" компонента, обновляя список выбранных дат.
    ...
    /**
     * Handles "selection change" component event (updates list of selected dates). <br>
     * Обрабатывает событие "selection change" компонента, обновляя список выбранных дат.
     * @param evt Event object.<br>
     * Объект, описывающий событие.
     * @since 1.0
     */
