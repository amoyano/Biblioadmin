/*
 * DateChooserBeanInfo.java
 *
 * Created on 5 Июль 2006 г., 17:21
 *
 */
...
/**
 * BeanInfo class for common properties of all components.<br> 
...
public abstract class AbstractDateChooserBeanInfo extends SimpleBeanInfo {
    ...
    /**
     * <b>Creates</b> array of common events descriptors.<br>
     * Создает массив описателей общих событий.
     * @return Array of EventSetDescriptor.<br>
    ...
    /**
     * <b>Creates</b> array of common properties.<br>
     * Создает массив описателей общих событий.
     * @return Array of PropertyDescriptor.<br>
    ...
    /**
     * Default propery index.<br>
     * Индеск свойства по умолчанию.
     * @return Default propery index.<br>
     * Индеск свойства по умолчанию.
     * @since 1.0
     */
    ...
    /**
     * Icon for components.<br>
     * Иконка компонента.
     * @param iconKind Icon properties.<br>
     * Свойства иконки.<br>
